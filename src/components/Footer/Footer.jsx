...
function Footer() {
  return (
    <section className="relative overflow-hidden py-5 bg-yellow-200 dark:bg-[#1E293B] border border-yellow-200 dark:border-[#1E293B] dark:border-t-[#475569] border-t-2 border-t-orange-200 transition-all duration-500 ease-in-out">
      <div className="relative z-10 mx-auto max-w-7xl px-4">
        <div className="w-full p-6 flex flex-col sm:flex-row items-center sm:justify-between gap-4">
          ...
          <div className="text-center sm:text-left">
            <p className="text-sm inline-block transition-all duration-500 ease-in-out text-gray-600 dark:text-[#F8FAFC] ">
